  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage:
            'repeating-linear-gradient(90deg, #76ABAE 0px, #76ABAE 1px, transparent 1px, transparent 80px), repeating-linear-gradient(0deg, #76ABAE 0px, #76ABAE 1px, transparent 1px, transparent 80px)',
        }}
      />
      {/* Número decorativo */}
      <div
      ...
      <div className="relative flex flex-col items-center text-center z-10 max-w-xs">
        ...
        <h2
          className="font-display font-black tracking-tighter mt-2 mb-1 lg:mt-6 lg:mb-2"

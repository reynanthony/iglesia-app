...
import { deleteReadingPlan } from '@/app/actions/bible-reading-plans'
import { Trash2 } from 'lucide-react'
import { CARD, BORDER } from '@/lib/gold-theme'

export default function DeleteReadingPlanButton({ planId }: { planId: string }) {
  ...
  return (
    <button
      onClick={handleClick}
      disabled={isPending}
      title={confirm ? '¿Confirmar eliminación?' : 'Eliminar plan'}

...
export default function PageEditorTabs({ page, pageLabel, initialBlocks, initialValues, previewPath }: Props) {
  ...
  return (
    <div className="min-h-screen" style={{ background: '#061E30', color: '#F6F3EB' }}>
      {/* Header */}
      <div className="px-8 pt-8 pb-0" style={{ borderBottom: '1px solid #0D3352' }}>
        <div className="flex items-end justify-between mb-0 pb-0">
          <div>
            ...
            <h1 className="text-2xl font-black tracking-tight" style={{ color: '#F6F3EB' }}>
              {pageLabel}
            </h1>
          </div>
          <a
            ...
            className="text-[11px] font-bold uppercase tracking-[0.18em] px-5 py-2.5 rounded-xl transition mb-2"
        ...
        <div className="flex gap-1 mt-6">
          {tabs.map(t => (
            <button
              ...
              className="px-5 py-3 text-[11px] font-bold uppercase tracking-[0.18em] transition rounded-t-xl"
              style={{

    ...
    <div style={{ background: BG, minHeight: '100%' }}>
      ...
      <div className="relative overflow-hidden" style={{ borderBottom: `1px solid ${BORDER}` }}>
        <div className="absolute inset-0 pointer-events-none"
          style={{ background: `radial-gradient(ellipse 60% 100% at 50% 0%, ${GOLD}12, transparent 70%)` }} />
          ...
          <div className="flex items-start justify-between">
            <div>
              ...
              <h1 className="font-black tracking-tighter"
                ...
                Salas de<br /><span style={{ color: GOLD }}>Oración.</span>
              </h1>
        ...
        {!rooms || rooms.length === 0 ? (
          <div className="text-center py-24 flex flex-col items-center">
            <div className="w-14 h-14 rounded-2xl flex items-center justify-center mb-5"
              ...
              <Mic2 size={24} style={{ color: `${GOLD}66` }} />
            </div>
                ...
                <div className="p-5 md:p-6">
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[10px] font-bold uppercase tracking-widest"
                        style={{ color: MUTED }}>En vivo</span>
                    </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="font-black text-base tracking-tight" style={{ color: INK }}>
                        {room.name}
                      </p>
                      {room.description && (

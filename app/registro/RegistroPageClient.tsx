...
function RegistroForm({ siteName }: { siteName: string }) {
    ...
    <div className="w-full max-w-sm">
      ...
      <div className="mb-5">
        ...
        <p className="text-sm text-[#111111]/50">
          Únete a la comunidad de {siteName}
        </p>
      </div>
...
export default function RegistroPageClient({ siteName = 'El Manantial' }: { siteName?: string }) {
  return (
    <main className="h-screen overflow-hidden flex flex-col lg:flex-row">
      ...
      >
        <div className="min-h-full flex items-center justify-center px-6 py-8 lg:py-16">
          <RegistroForm siteName={siteName} />
        </div>
      </div>
    </main>
  )
